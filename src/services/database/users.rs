...
use crate::utils::apierror::{ApiError, error_conflict, error_forbidden, error_invalid_request, error_not_found, specialize};
...
impl Database {
        ...
        FUT: Future<Output = ()>,
    {
        ...
        Err(AuthenticationError::Unauthorized) // error_unauthorized()
    }
