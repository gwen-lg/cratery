...
pub(crate) struct EmbeddedResources {
    /// The known resources
    pub(crate) data: HashMap<&'static str, EmbeddedResource>,
...
impl EmbeddedResources {
    ...
    #[must_use]
    pub(crate) fn with_fallback(fallback: &'static str) -> Self {
        Self {
            data: HashMap::new(),
            fallback,
        }
    ...
    #[must_use]
    pub(crate) fn get(&self, path: &str) -> Option<&EmbeddedResource> {
...
#[must_use]
pub(crate) fn get_content_type(path: &str) -> &'static str {
...
impl WebappResource {
    ...
    #[must_use]
    pub(crate) const fn content_type(&self) -> &str {
        match self {
    ...
    #[must_use]
    pub(crate) fn into_data(self) -> Cow<'static, [u8]> {
        match self {
