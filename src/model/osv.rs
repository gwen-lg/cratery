...
pub enum SimpleAdvisoryError {
    ...
    #[error("missing crates.io package in affected")] //TODO: determining a valid and comprehensive error message
    NoCratesIoPackage,

    #[error("TODO")]
    MissingIntroducedEvent,

    #[error("parse package introduced value")]
        ...
        let ranges = affected
            ...
            .map(|range| {
                let introduced = range
                    ...
                    .ok_or(Self::Error::MissingIntroducedEvent)?;
