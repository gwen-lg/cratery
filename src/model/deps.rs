...
pub(crate) const BUILTIN_CRATES_REGISTRY_URI: &str = "<builtin>";

/// The list of built-in crates
pub(crate) const BUILTIN_CRATES_LIST: &[&str] = &["core", "alloc", "std"];

/// The specification for a dependency analysis job
#[derive(Debug, Serialize, Deserialize, Clone)]
pub(crate) struct DepsAnalysisJobSpec {
...
#[derive(Debug, Serialize, Deserialize, Clone)]
pub(crate) struct DepsAnalysisState {
    /// The name of the crate
    pub(crate) package: String,
    /// The crate's version
    pub(crate) version: String,
...
pub(crate) struct DepsAnalysis {
    /// The direct dependencies
    #[serde(rename = "directDependencies")]
    pub(crate) direct_dependencies: Vec<DirectDepInfo>,
    /// The advisories against dependencies
    pub(crate) advisories: Vec<DepAdvisory>,
}

impl DepsAnalysis {
    /// Creates the analysis
    #[must_use]
    pub(crate) fn new(graph: &DepsGraph, deps: &[IndexCrateDependency], advisories: Vec<DepAdvisory>) -> Self {
        Self {
...
pub(crate) struct DirectDepInfo {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub(crate) struct DepAdvisory {
    /// The name of the package
    pub(crate) package: String,
    /// The resolved version
    pub(crate) version: Version,
    /// The advisory itself
    pub(crate) content: SimpleAdvisory,
}
...
pub(crate) struct DepsGraph {
    ...
    pub(crate) crates: Vec<DepsGraphCrate>,
    /// The list of unknown crates that failed before
    pub(crate) unknowns: Vec<(Option<String>, String)>,
    /// The crate and resolution to analyse
    pub(crate) dirty: Vec<(usize, usize)>,
}
...
impl DepsGraph {
    ...
    pub(crate) fn get_crate(&mut self, registry: Option<&str>, name: &str) -> Option<(usize, &mut DepsGraphCrate)> {
        self.crates
            .iter_mut()
            .enumerate()
    ...
    #[must_use]
    pub(crate) fn is_unknown(&self, registry: Option<&str>, name: &str) -> bool {
    ...
    pub(crate) async fn close<F, FUT>(&mut self, get_versions: &F) -> Result<(), ApiError>
    where
        F: Fn(Option<String>, String) -> FUT + Sync,
        FUT: std::future::Future<Output = Result<Vec<IndexCrateMetadata>, ApiError>>,
    {
...
pub(crate) enum DepsGraphCrateOrigin {
...
impl DepsGraphCrateOrigin {
    ...
    #[must_use]
    pub(crate) const fn child_of_kind(self, kind: DependencyKind) -> Option<Self> {
        match (self, kind) {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub(crate) struct DepsGraphCrateVersion {
    /// The semver version
    pub(crate) semver: Version,
    /// The index metadata
    pub(crate) metadata: IndexCrateMetadata,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub(crate) struct DepsGraphCrateResolution {
    ...
    pub(crate) origins: Vec<DepsGraphCrateOrigin>,
}

/// A crate in a graph of dependencies
#[derive(Debug, Clone, Serialize, Deserialize)]
pub(crate) struct DepsGraphCrate {
    /// URI for the owning registry, `None` for the local one
    pub(crate) registry: Option<String>,
    /// The name of the package
    pub(crate) name: String,
    /// All the known versions
    pub(crate) versions: Vec<DepsGraphCrateVersion>,
    ...
    pub(crate) resolutions: Vec<DepsGraphCrateResolution>,
    /// The list of unresolved requirements for this crate
    pub(crate) unresolved: Vec<VersionReq>,
}

impl DepsGraphCrate {
    /// Creates the data for this crate
    pub(crate) fn new(package: &IndexCrateDependency, versions: Vec<IndexCrateMetadata>) -> Result<Self, semver::Error> {
    ...
    pub(crate) fn get_active_deps_in<'this: 'targets, 'targets>(
        &'this self,
